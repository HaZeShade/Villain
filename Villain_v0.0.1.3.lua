...
MiClose.Activated:Connect(function()Villain:Destroy();script:Destroy()end)
MaClose.Activated:Connect(function()Villain:Destroy();script:Destroy()end)
...
while wait(1.5) do
	...
	if FSToggle then
		...
		elseif game.Players.LocalPlayer.PrivateStats.FistStrength.Value > 1000000000 then
			remote("FS4")
		elseif game.Players.LocalPlayer.PrivateStats.JumpForce.Value > 10000 and game.Players.LocalPlayer.PrivateStats.PsychicPower.Value > 10000 then
			remote("FS3")
		else
			remote("FS2")
		end
