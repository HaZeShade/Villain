...
local BTFarmToggleButton = Instance.new("TextButton")
...
BTFarmToggleButton.Parent = BTFarming
BTFarmToggleButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
BTFarmToggleButton.Position = UDim2.new(0.656862736, 0, 0.186746985, 0)
BTFarmToggleButton.Size = UDim2.new(0, 19, 0, 19)
BTFarmToggleButton.Font = Enum.Font.SourceSansBold
BTFarmToggleButton.Text = ""
BTFarmToggleButton.TextColor3 = Color3.fromRGB(255, 0, 0)
BTFarmToggleButton.TextScaled = true
BTFarmToggleButton.TextSize = 14.000
BTFarmToggleButton.TextWrapped = true

UICorner_7.CornerRadius = UDim.new(0, 6)
UICorner_7.Parent = BTFarmToggleButton
...
BTFarmToggleButton.Activated:Connect(function()
	
	BTFarmToggle = not BTFarmToggle
	if BTFarmToggle then
		BTFarmToggleButton.BackgroundColor3 = Color3.new(0,1,0)
	else
		BTFarmToggleButton.BackgroundColor3 = Color3.new(1,0,0)
	end
